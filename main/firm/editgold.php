...
<?php
                                ...
                                ?>
<h2 class="center-text">Edit <?php gdetail($myid, 'item'); ?></h2>
</div>
</div>
...
<input type="text" name="item" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'item'); ?>">
...
<input type="text" name="purity" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'purity'); ?>">
</div>

<div class="form-group">
<label for="exampleFormControlInput1">Carat</label>
<input type="text" name="carat" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'carat'); ?>">
</div>

<div class="form-group">
<label for="exampleFormControlInput1">Demurage Charge</label>
<input type="text" name="charge" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'charge'); ?>">
</div>


<div class="form-group">
<label for="exampleFormControlInput1">Date Deposited</label>
<input type="text" name="date_added" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'date_added'); ?>">
</div>


<div class="form-group">
<label for="exampleFormControlInput1">Owner's Full Name</label>
<input type="text" name="depositer" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'depositer'); ?>">
</div>


<div class="form-group">
<label for="exampleFormControlInput1">Date of Birth</label>
<input type="text" name="dob" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'dob'); ?>">
</div>
...
<input type="text" name="nationality" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'nationality'); ?>">
</div>
...
<input type="text" name="occupation" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'occupation'); ?>">
</div>

<div class="form-group">
<label for="exampleFormControlInput1">Address</label>
<input type="text" name="address" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'address'); ?>">
</div>

<div class="form-group">
<label for="exampleFormControlInput1">Next of Kin</label>
<input type="text" name="next_kin" class="form-control" id="exampleFormControlInput1" placeholder="" value="<?php gdetail($myid, 'next_kin'); ?>">
</div>
