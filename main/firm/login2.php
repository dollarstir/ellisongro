<?php loginpagechecker('vaultuser', 'vault'); ?>
<!DOCTYPE html>
<html lang="zxx">
<head>
...
<title>Vault Authenticator</title>
...
<div class="form-group">
<input type="password" name="vault" class="form-control" placeholder="Enter Vault Number">
</div>
<button type="submit"   class="btn btn-primary cc" >Open Vault</button>
